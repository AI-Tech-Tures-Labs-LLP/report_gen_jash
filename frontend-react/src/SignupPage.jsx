...
/**
 * SignupPage — Only accessible via /create-account URL.
 * Same Apple-inspired white & gold design as the login page.
 */
export default function SignupPage({ onSignup }) {
  ...
  const isValid = email.trim() && password.length >= 6 && name.trim();
...
const styles = {
  ...
  hint: { fontSize: "0.72rem", color: "#a0a8b4", margin: "0.15rem 0 0 2px", fontWeight: 400 },
  error: {
  ...
  footer: {
    textAlign: "center", marginTop: "1.25rem", fontSize: "0.82rem",
